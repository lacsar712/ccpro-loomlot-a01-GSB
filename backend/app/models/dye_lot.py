...
class DyeLot(Base):
    ...
    fixation_dwells: Mapped[List["FixationDwell"]] = relationship(
        "FixationDwell", back_populates="dye_lot", cascade="all, delete-orphan"
    )
    fabric_weights: Mapped[List["FabricWeight"]] = relationship(
        "FabricWeight", back_populates="dye_lot", cascade="all, delete-orphan"
    )
